    ...
    echo " <form method='post'>
            <div class='row'>
                ...
                <div class='input-field col s12 l12 m12'>
                    ...
                    <a class='modal-close waves-effect waves-light btn right' onclick='actualizarRegistro(); actualizarAsiento();'>
                            <i class='material-icons center'>update</i>
                        </a>
                        <a class='modal-close waves-effect waves-light btn right' style='margin-right: 10px' onclick='eliminarVenta(\"$seat\"); eliminarAsiento($seat);'>
